            ...
            *********************************************************************************/
            ...
            if (!accountExists(partsOfLine[0]) && fork() == 0)
            {
                ...
                case 2:
                {
                    ...
                    Inquiry inquiryTransaction(partsOfLine, sharedMemory);
                    break;
                }
                case 3:
                {
                    // add code for deposit class
                    Deposit depositTransaction(partsOfLine, sharedMemory);
                    break;
                }
                case 4:
                {
            ...
            else if (accountExists(partsOfLine[0]))
            {
                ...
                {
                    // add code for deposit class
                    // Assuming partsOfLine and sharedMemory are available here
                    Deposit depositTransaction(partsOfLine, sharedMemory);
                    break;
                }
                case 4:
